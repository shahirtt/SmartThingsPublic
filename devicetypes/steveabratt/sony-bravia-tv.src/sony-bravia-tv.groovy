...
preferences {    
	section("Internal Access"){
        ...
        input "KEY_VOLUP", "text", title: "Volume Up", description: "(RM Bridge code name)" , required: false
...
metadata {
  definition (name: "Sony Bravia TV", namespace: "steveAbratt", author: "Steve Bratt") {
    ...
    standardTile("KEY_VOLUP", "device.switch", decoration: "flat", canChangeIcon: false) {
    ...
    main "switch"
    details (["power","stb","sound", "chup","prech","KEY_VOLUP","chdown","mute","voldown", "HDMI", "Up", "tools", "Left", "Enter", "Right", "Return", "Down", "menu","Exit", "Info","Size","Sleep"])	
}
